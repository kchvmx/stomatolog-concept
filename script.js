const translations = {
  ua: {
    ...
    "hero.eyebrow": "Сімейна стоматологія нового покоління", "hero.title": "Сімейна стоматологія у Львові", "hero.text": "Первинна консультація <span class=\"accent-underline\">безкоштовно</span>.", "hero.cta": "Записатися на безкоштовну консультацію ↗", "hero.more": "Дізнатися більше ↓", "hero.microcopy": "✓ Без спаму. Передзвонимо протягом 15 хвилин у робочий час", "hero.proof": "років практики", "hero.review": "Дуже сподобалось, що все пояснили й одразу склали зрозумілий план лікування. На консультації було спокійно, а результат перевершив очікування.", "hero.reviewRole": "· пацієнтка Milo Dental", "hero.noteTitle": "Піклуємося по-справжньому", "hero.noteText": "Спокійно. Професійно. Поруч.", "hero.badge": "на Google, 180+ відгуків",
...
function setLanguage(lang) {
  ...
  document.querySelectorAll('.language').forEach((button) => button.classList.toggle('is-active', button.dataset.lang === lang));
